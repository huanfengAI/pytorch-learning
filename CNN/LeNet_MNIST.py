...
class LeNet(nn.Module):
    def __init__(self):
        ...
        layer1.add_module('conv1',nn.Conv2d(1,20,5,padding=1))
        layer1.add_module('pool1',nn.MaxPool2d(2,2))
        self.layer1=layer1
		
        layer2=nn.Sequential()
        layer2.add_module('conv2',nn.Conv2d(20,50,5))
        layer2.add_module('poo2',nn.MaxPool2d(2,2))
        self.layer2=layer2
		
        layer3=nn.Sequential()
        layer3.add_module('fc1',nn.Linear(800,500))
        layer3.add_module('relu1',nn.ReLU(True))
        layer3.add_module('fc2',nn.Linear(500,84))
